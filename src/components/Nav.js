  ...
  <div className='fl w-10 bg vh-100 dt'>
    <div className='dtc v-mid tc'>
      <Tippy content='Home' placement='right'>
        <svg className='w-50' id='goHome' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
          <path d='M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z' />
        </svg>
      </Tippy>
      <Tippy content='Profile' placement='right'>
        <svg className='w-50' id='user' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
          <defs />
      ...
      <Tippy content='Servers' placement='right'>
        <svg className='w-50' id='server' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 56 56'>
          <defs />
